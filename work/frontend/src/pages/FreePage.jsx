              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {safeMap(novels, (novel, idx) => (
                  ...
                  >
                    <Link
                      to={`/novel/${novel.slug}`}
                      className="group block h-full bg-slate-900 rounded-xl overflow-hidden border border-slate-800 hover:border-purple-500/50 transition-all hover:shadow-2xl hover:shadow-purple-900/10"
                    >
                      ...
                      <div className="p-4">
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          {parseTags(novel.tags).slice(0, 2).map((tag) => (
                            <Badge key={tag} variant="outline" className="border-slate-700 text-xs text-slate-500">
                              {tag}
                            </Badge>
                          ))}
                        </div>
