    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-page flex flex-col items-center justify-center p-4 text-center">
          <div className="bg-white border border-slate-200 shadow-xl rounded-xl p-8 max-w-md w-full shadow-2xl">
            ...
            <div className="flex gap-4 justify-center">
              <Button onClick={() => window.location.href = '/'} variant="outline" className="border-slate-200 hover:bg-stone-50">
                Go Home
              </Button>
              <Button onClick={this.handleReload} className="bg-accent-600 hover:bg-accent-700 gap-2">
