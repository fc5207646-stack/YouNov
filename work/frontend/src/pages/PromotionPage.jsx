    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-white mb-4">邀请推广</h1>
          <p className="text-slate-400 text-lg">统计点击 / 注册 / 订阅，便于拉新与裂变增长</p>
        </div>
        ...
        {loading ? (
          ...
          <Card className="bg-slate-900 border-slate-800 text-center p-8">
            <CardContent>
              ...
              <p className="text-slate-400 mb-6">登录后可查看你的邀请码与推广数据</p>
          ...
          <>
            <Card className="bg-gradient-to-r from-purple-900/40 to-pink-900/40 border-purple-500/30 mb-8">
              <CardHeader>
                ...
                <CardDescription className="text-slate-300">分享邀请码或邀请链接给好友</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="flex items-center justify-between bg-slate-950/50 rounded-lg p-4 border border-slate-700">
                  <span className="text-2xl font-mono font-bold text-white">{referral?.code || '—'}</span>
                  <Button onClick={() => copyToClipboard(referral?.code)} variant="ghost" size="sm" className="text-purple-400 hover:text-purple-300">
                    <Copy className="w-4 h-4" />
                  </Button>
                </div>
                <div className="flex items-center justify-between bg-slate-950/40 rounded-lg p-3 border border-slate-800">
              ...
              <Card className="bg-slate-900 border-slate-800">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-slate-400">注册人数</span>
                  </div>
                  <p className="text-3xl font-bold text-white">{referral?.registers || 0}</p>
                </CardContent>
              </Card>
              <Card className="bg-slate-900 border-slate-800">
                <CardContent className="p-6">
                  ...
                  <p className="text-3xl font-bold text-white">Level {currentLevel + 1}</p>
                </CardContent>
              </Card>
              <Card className="bg-slate-900 border-slate-800">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-slate-400">订阅转化</span>
                  </div>
                  <p className="text-3xl font-bold text-white">{referral?.subscribes || 0}</p>
                </CardContent>
              </Card>
            </div>
            ...
            <Card className="bg-slate-900 border-slate-800 mb-8">
              <CardHeader>
                <CardTitle className="text-white">成长进度</CardTitle>
                <CardDescription className="text-slate-400">按注册人数升级（示例规则：5 / 10）</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
            ...
            <Card className="bg-slate-900 border-slate-800">
              <CardHeader>
                <CardTitle className="text-white">推广数据</CardTitle>
                <CardDescription className="text-slate-400">汇总统计</CardDescription>
              </CardHeader>
